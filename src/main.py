...
async def main():
    ...
    commands = [
        ...
        BotCommand(command="eye", description="Начать задание"),
        BotCommand(command="face", description="Начать задание"),
        BotCommand(command="feet", description="Начать задание"),
        BotCommand(command="full_body", description="Начать задание"),
        BotCommand(command="hands", description="Начать задание"),
        BotCommand(command="neck", description="Начать задание"),
        BotCommand(command="picking_up", description="Начать задание"),
        BotCommand(command="plank", description="Начать задание"),
        BotCommand(command="running", description="Начать задание"),
        BotCommand(command="squats", description="Начать задание"),
        BotCommand(command="walking", description="Начать задание"),
    ]
