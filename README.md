...
> Проект реализован в режиме «вайбкодинга»: ChatGPT использовался для превращения требований заказчика в ТЗ для LLM, а Cursor выступал как основной разработчик. Подход — BDD (сценарии от поведения пользователя), продукт уже работает в продакшне для самарской клиники.
